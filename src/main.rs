...
fn main() {
    ...
    */
    ...
    let mut section_pad: Vec<u8> = Vec::new();
    for _ in 1..=((2 as u32).pow(5) as usize - bin.len()) {
        section_pad.push(0x00);
    }
    let section = [
    ...
    section_pad.append(&mut section.to_vec());
    let section = section_pad;
    ...
    let textoff = (size_of::<elf64_header>()) as u64;
    ...
    */
    ...
    println!("{}", textoff);
    println!("{}", shoff);
    println!("{}", size_of::<elf64_header>() + bin.len());
    println!("{}", (16 * bin.len() as u32));
}
